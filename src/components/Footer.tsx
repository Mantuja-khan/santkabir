    ...
    <div className="container mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div>
        ...
        <div className="space-y-3 text-sm">
          ...
          <p className="flex items-start gap-2"><MapPin className="w-4 h-4 mt-0.5 text-primary" />  St. Kabir Public Sr. Sec. School, NRP Bass Road, Alawalpur, Dharuhera, Rewari</p>
